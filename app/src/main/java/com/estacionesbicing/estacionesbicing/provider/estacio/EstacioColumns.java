...
import com.estacionesbicing.estacionesbicing.provider.ExampleProvider;
import com.estacionesbicing.estacionesbicing.provider.estacio.EstacioColumns;

/**
 * Columns for the {@code estacio} table.
 */
public class EstacioColumns implements BaseColumns {
    public static final String TABLE_NAME = "estacio";
